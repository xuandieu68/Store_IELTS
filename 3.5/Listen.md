...
* depart (v) khởi hành 
* pricey (adj) đắt đỏ  
* preference (n) sự ưu tiên, sở thích 
* emergency (n) tình huống khẩn cấp 
* insurance bảo hiểm
* enroll (v) : đăng ký
coach (n) xe buýt đường dài \
lodge (n) nhà nghỉ (thường ở vùng quê, thiên nhiên)\
accommodate (v) đáp ứng,chứa \
...
# 3. Other
outgrow : lớn, vượt qua\
in case of : trong trường hợp\
process : chuẩn bị\
actrually: thực ra thì\
the rest: phần còn lại\
almost: gần, sắp\
correct: đúng\
allergy(n), tobe allergies to: dị ứng với cái gì\
instead, instead of :\
Coverage : bao gồm, phạm vi bảo hiểm\
